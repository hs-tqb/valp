...
export default {
  ...
  news: {
    items:[
      { 
        link:'/news/1', 
        img:'http://otydyl8j5.bkt.clouddn.com/valp/news/1/0-en.png?imageslim',
      ...
      { 
        link:'/news/2', 
        img:'http://otydyl8j5.bkt.clouddn.com/valp/news/2/0-en.png?imageslim',
      ...
      {
        link:'/news/3', 
        img:'http://otydyl8j5.bkt.clouddn.com/valp/news/3-temp/0-en.png?imageslim',
        title:'ValPromise Attended Roadshow in Shenzhen',
        paras:[
      ...
      },
      {
        ...
        paras:[
          ...
          { type:'p', content:'When talking about one of the topics of this summit - Blockchain, he stated that blockchain is a technology system which can be maintained by multiple parties, use blockchain structure to store data, use cryptography to ensure the security of transmission and access and achieve consistent storage of data. Xiang was convinced that this untampered and undeniable system will bring infinite imagination to people around the world.'},
          {type:'p', content:'Xiang Tao\'s passionate speech not only won the recognition of the audience, but also sparked a heated discussion about blockchain and finance.'},
          { type:'img', src:'http://otydyl8j5.bkt.clouddn.com/valp/news/4/3.jpg?imageslim' },
          {type:'p', content:'In order to thank all the participants, Xiang Tao also gave each of them a gift of 50VPP with full of sincerity. '},
          { type:'img', src:'http://otydyl8j5.bkt.clouddn.com/valp/news/4/4.jpg?imageslim' },
        ]
      },
      // {
      //   link:'/news/5',
      //   img:'http://otydyl8j5.bkt.clouddn.com/valp/news/5-temp/0-en.png?imageslim',
      //   title:'',
      //   paras:[
      //     {type:'p', content:''},
      //     {type:'img', src:"http://otydyl8j5.bkt.clouddn.com/valp/news/5/1.png?imageslim"}
      //   ]
      // },
      {
        link:'/news/5',
        img:'http://otydyl8j5.bkt.clouddn.com/valp/news/5/0-en.png?imageslim',
        title:'ValPromise Roadshow in The Second Guangdong-HK-Macao Bay Area Blockchain Future Technology Summit.',
        paras:[
          {type:'p', content:'On March 20th,  ValPromise participated in The Second Guangdong-HK-Macao Bay Area Blockchain Future Technology Summit in Shenzhen. The theme of the summit was “Blockchain - A Future Technology  Leads Industry Innovation”.'},
          {type:'p', content:'The mobile value commitment trading platform based on blockchain from ValPromise received a lot of attention. During the summit meeting, ValPromise\'s publicity platform attracted many people, who expressed strong interest in ValPromise\'s forthcoming disintermediated distribution system of financial products and the introduction of weather contracts and insurances from Tianqibao. '},
          ...
          {type:'p', content:'After the evening banquet, ValPromise\'s founder and keynote guest, Xiang Tao, introduced ValPromise in detail like the application scenarios and innovations for the investors, entrepreneurs and blockchain enthusiasts.'},
          ...
          {type:'p', content:'Xiang Tao said that VPP uses weather insurance as the breakthrough point and will eventually evolve into a global financial derivative contract (linked objective index) distribution - trading system.'},
          {type:'p', content:'He also stated that the VPP project can be perfectly applied in the following areas: index insurance, such as weather insurance; OTC commodities & precious metals futures; OTC futures and options; various types of off-exchange options linked to stocks, futures, and foreign exchange indices; forecast contracts for objective and public indicators and so on.'},
          {type:'p', content:'In addition, VPP project will effectively meet the risk hedge service requirements from real-world and significantly reduce the threshold for participants. The system\'s initial business-weather insurance has entered the market and has already served hundreds of thousands of real economy users.<br>ValPromise\'s team owns the first-rate background and perfect cooperation. So far, ValPromise has obtained two rounds of Chinese famous investors legal tender investment. At present, the issuance of the token has been subscribed by Qtum, Wang Lijie and so on.'},
          ...
          {type:'p', content:'To thank all the participants and investors at the summit to support ValPromise, Xiang Tao gave each of them a gift of 30VPP with full of sincerity after the speech.'},
          {type:'p', content:'This weekend, ValPromise will bring a better roadshow at the 2018 Asia Pacific Blockchain Summit in Tokyo. Please look forward to it.'},
        ]
      }
    ],
  ...
  investors: {
    ...
    items:[
      ...
      },
      {
        ...
        desc:'Melody is the founder of Spartan Group and blockchain consulting. She is an early investor in TenX and strategic advisor to Gifto and Appcoins.She used to work for Goldman Sachs.'
      },
    ],
    agency: {
