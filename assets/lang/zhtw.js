...
export default {
  ...
  slogan:'分布式價值承諾協議',
  fcoin:['ValPromise首发Fcoin!','合约交易大赛开启!'],
  whitePaper:{
  ...
  team: {
    ...
    items:[
      ...
      {
        name:'AnnaZhang',
        avatar:'https://ico.ggt.io/static/images/Anna.jpeg',
        desc:'90后连续创业者，大二开始创业，被评选为江苏省大学生科技创业二等奖，项目曾为“饿了么”最强劲对手，实现自助零售货架业务一月内扩3所高校覆盖9万人，3月后实现盈利的成绩；虚拟货币的早期参与者，17年加入新加坡区块链投资团队（参与项目Origin Protocol, Boosto, Inkl, Gifto, Market Protocol, Artval)，参与项目的咨询，投资以及国际路演策划，拥有丰富的区块链市场拓展与运营经验。'
      },
      // {
      //   name:'焦臻',
